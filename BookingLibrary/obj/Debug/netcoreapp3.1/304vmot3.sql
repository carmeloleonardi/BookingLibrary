...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'EditorId', N'EditorName') AND [object_id] = OBJECT_ID(N'[Editors]'))
    SET IDENTITY_INSERT [Editors] ON;
INSERT INTO [Editors] ([EditorId], [EditorName])
...
VALUES (N'20201104175442_InitialMigrate', N'3.1.9');
